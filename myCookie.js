    ...
    init: function(t) {
      ...
      if (
        ((this.default_options = {
          ...
          position: 'bottom',
          message:
            'We use just strictly necessary cookies required for website functionality and safety. By continuing to visit this site you agree to our use of cookies.',
          linkmsg: 'More info',
          scriptmsg: 'Cookie Info',
          moreinfo: '/FAQ',
